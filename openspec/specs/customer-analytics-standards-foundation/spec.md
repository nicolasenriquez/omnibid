# customer-analytics-standards-foundation Specification

## Purpose
TBD - created by archiving change customer-analytics-standards-foundation. Update Purpose after archive.
## Requirements
