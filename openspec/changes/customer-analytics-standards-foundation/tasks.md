...
- [ ] 1.1 Create `docs/standards/customer-analytics-standards.md`.
...
- [ ] 1.2 Create `docs/references/sdd-customer-analytics-standards-2026-05-05.md`.
...
- [ ] 2.1 Update `docs/references/sdd-official-sources-registry.md`.
...
- [ ] 2.2 Align `docs/standards/postgres-standard.md` with the effective Compose image.
...
- [ ] 3.1 Add or extend source-profile routing helpers under `backend/pipeline/`.
...
- [ ] 3.2 Add runtime validation for the DB/env split.
...
- [ ] 3.3 Tighten the existing contract helpers used by ingestion and pipeline orchestration.
...
- [ ] 3.4 Add unit tests for routing and runtime validation.
...
- [ ] 4.1 Review the docs and code for internal consistency.
...
- [ ] 4.2 Keep the runtime schema unchanged in this slice.
