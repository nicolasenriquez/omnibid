...
- [ ] 1.1 Freeze the NLP standard in `docs/standards/nlp-standards.md`.
...
- [ ] 1.2 Record the decision in `docs/references/sdd-nlp-standards-2026-05-05.md`.
...
- [ ] 1.3 Update the official sources registry and engineering standards index.
...
- [ ] 2.1 Add `backend/nlp/` pipeline helpers.
...
- [ ] 2.2 Add `config/nlp/` versioned config and patterns.
...
- [ ] 2.3 Add the operator entrypoint `scripts/build_nlp_annotations.py`.
...
- [ ] 2.4 Add explicit runtime-validation glue for the NLP job surface.
...
- [ ] 3.1 Wire the pipeline to the existing Silver annotation rows.
...
- [ ] 3.2 Enforce the no-vectors, no-scores Silver boundary.
...
- [ ] 3.3 Keep embeddings downstream only.
