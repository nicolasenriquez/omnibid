# mercado-publico-snapshots Specification Delta

## Purpose
Extend the existing snapshot specification with enriched field requirements for detail-by-codigo payloads.
